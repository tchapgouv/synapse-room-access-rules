...
class RoomAccessRules(object):
    ...
    async def on_create_room(
        ...
        if access_rule_event:
            ...
            encrypted_rule = access_rule_event.get("content", {}).get("encrypted")
            ...
            initial_state[(ACCESS_RULES_TYPE, "")] = {
        ...
        # TODO check if access rule matters here
        if (
        ...
        if preset == RoomCreationPreset.PRIVATE_CHAT and encrypted_rule is False:
            force_encryption = False
